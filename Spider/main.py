...
class MainSpider:
    # 初始化，共用变量
    def __init__(self):
        self.url = "https://detail.tmall.com/item.htm?abbucket=3&id=915107045063&mi_id=0000UalZGr13Mxv9mChjmHAc3nHg5zN60YaxtvQM1iPic-4&ns=1&skuId=5947335062221&spm=a21n57.1.hoverItem.2&utparam=%7B%22aplus_abtest%22%3A%225b753555d091ea1103f35c43eee05ab2%22%7D&xxc=taobaoSearch"
        # 内网测试
    ...
    def refresh_cookies(self):
        cookies_path = "/Users/lamlam/PycharmProjects/Spider/cookies.json"
    ...
    def get_res_url(self):
        ...
        '''self.res = re.findall(
            pattern=r'(?:video-sh.cloudvideocdn.taobao.com|tbm-auth.alicdn.com)/.{,200}?auth_key.{,300}?taobao',
            string=html)
        if self.res:
